...
<link href="<%=request.getContextPath() %>/css/bootstrap.css" rel="stylesheet" type="text/css"
	media="all" />
<!-- pop-up -->
<link href="<%=request.getContextPath() %>/css/popuo-box.css" rel="stylesheet" type="text/css"
	media="all" />
<!-- //pop-up -->
<link href="<%=request.getContextPath() %>/css/easy-responsive-tabs.css" rel='stylesheet'
	type='text/css' />
...
<jsp:include page="includes/index_content.jsp"></jsp:include>
	...
	<script>
		...
		.ready(
				function() {
					...
					$('.wthree_agile-movies_list .w3l-movie-gride-agile .agileits_w3layouts_mid_1_home .w3l-movie-text h6 a')
							.each(
									function() {
		...
		.ready(
				function() {
					// Configure/customize these variables.
					var showChar = 22; // How many characters are shown by default
					$('.w3l-movie-gride-slider .agileits_w3layouts_mid_1_home .w3l-movie-text h6 a')
							.each(
									function() {
										var content = $(this).html();
