...
<%
	ArrayList<Movie> listByCate = cDAO.getListMoviesByCategory(idCategory);
	int pages = 0,first=0,max=0,total=0;
	if(request.getParameter("pages") != null) {
		pages = Integer.parseInt((String) request.getParameter("pages"));
	}
	total = cDAO.countMovieByCategory(idCategory);
	if(total <= 15) {
		first = 0;
		max = total;
	}else {
	...
	ArrayList<Movie> listMoviePagi = cDAO.getMovieFromeCategory(idCategory, first, max);
%>
<!DOCTYPE html>
<html>
<head>
<title><%=cDAO.getCategory(idCategory).getName()%></title>
<!-- for-mobile-apps -->
...
<div class="w3_breadcrumb">
	<div class="breadcrumb-inner">
		<ul>
			...
			<li><%=cDAO.getCategory(idCategory).getName()%></li>
		</ul>
	</div>
</div>
<!-- //breadcrumb -->
...
<div class="w3_content_agilleinfo_inner">
	<div class="agile_featured_movies">
		...
		<h3 class="agile_w3_title hor-t">
			Phim<span><%=cDAO.getCategory(idCategory).getName() %></span>
		</h3>
		...
		<div class="blog-pagenat-wthree">
			...
			<%if(pages == 1) { %>
				...
				<%} else { %> 
				<li><a class="frist" href="genre.jsp?categoryID=<%=idCategory%>&pages=<%=pages-1%>">Prev</a></li>
				<%} %>
				...
				<li><a href="genre.jsp?categoryID=<%=idCategory%>&pages=<%=i%>"><%=i %></a></li>
			<%} %>
			<%if(pages == (int) numberOfPages)  {%>
				<li><a class="last" href="#">Next</a></li>
				<%} else { %>
					<li><a class="last" href="genre.jsp?categoryID=<%=idCategory%>&pages=<%=pages+1%>">Next</a></li>
				<%} %>
			</ul>
